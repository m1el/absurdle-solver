...
plot \
    '../results/distribution-all-depth-2.dat' using 1:($1 <= 40 ? $2 : NaN) lt rgb '#43aa8b' with filledcurve y1=0 title 'explored paths', \
    '../results/distribution-all-depth-2.dat' lt rgb '#f3722c' with lines title 'distribution'
